	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="post" action="registerAction.php">
					...
					<div class="wrap-input100 validate-input">
						<input class="input100" type="text" name="midName" id="midName">
						<span class="focus-input100" data-placeholder="Mid Name"></span>
					</div>
					...
					<div class="wrap-input100 validate-input" >
						<input class="input100" type="text" name="age" id="age">
